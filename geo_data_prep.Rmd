...
saveRDS(ids, "use_case_data/geo_data/data/ids.rds")
```
...
```{r cutoff_assesment}
ids <- readRDS("use_case_data/geo_data/data/ids.rds")
...
# Change for different cutoffs variations
fc_cutoff <- 2
pCutoff <- 0.001
...
for (i in c(1:length(volcanos))) {
  ggsave(plot = volcanos[[i]], filename = paste0("plots_and_figures/geo/",
                                                 cutoff_combination,
                                                 "/volcano_plots/",
...
# ggsave(plot = grid,
#        filename = paste0("plots_and_figures/geo/", cutoff_combination, "/volcano_plots/grid_10_19.png"), 
#        width = 30, height = 30)
```
