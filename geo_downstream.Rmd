...
go <- read_gaf(filepath = "~/Downloads/sars-cov-2_targets.gaf") %>% select(GO_ID = "GO_ID", Aspect = "Aspect")
...
# Euler BP ####
venn.diagram(x = list(bp_terms, go_bp), category.names = c("topGO" , "GO"), filename = 'plots_and_figures/geo/LFC1_P0,001/euler/euler_bp.png',
        # Output features
          imagetype = "png",
          height = 1200,
          width = 1300,
        ...
        # Title
          ...
          main = "BP GO terms related to SARS-Cov-2 vs.\n topGO terms with p-val < 0.01",
          main.cex = 0.6)


# Euler MF ####
venn.diagram(x = list(mf_terms, go_mf), category.names = c("topGO" , "GO"), filename = 'plots_and_figures/geo/LFC1_P0,001/euler/euler_mf.png',
        # Output features
          imagetype = "png",
          height = 1200,
          width = 1300,
...
# Euler CC ####
venn.diagram(x = list(cc_terms, go_cc), category.names = c("topGO" , "GO"), filename = 'plots_and_figures/geo/LFC1_P0,001/euler/euler_cc.png',
        # Output features
          imagetype = "png",
          height = 1200,
          width = 1300,
