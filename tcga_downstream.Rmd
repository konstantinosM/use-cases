...
pathway$color[pathway$z_score_mean < -1] <- "#FF0000FF"
pathway$color[pathway$z_score_mean >= -1 & pathway$z_score_mean <= 3] <- "#FFFFFFFF"
pathway$color[pathway$z_score_mean > 3] <- "#00FF00"
...
```
## Compute Enrichment
The enrichment is computed in Gene Ontology (Process, Function and Component), KEGG and Reactome pathways, PubMed publications, UniProt Keywords, and PFAM/INTERPRO/SMART using an hypergeometric test and the FDR is calculated using Benjamini-Hochberg.
```{r compute_enrichmet}
# Set background 
