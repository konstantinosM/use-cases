...
z_score_2_results@configurations$`K-3-L1-150`
selected_pathway <- get_pathway(configuration = z_score_2_results@configurations$`K-3-L1-150`, pathway_name = "Pathway-1")
