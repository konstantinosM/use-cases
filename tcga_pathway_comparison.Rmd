...
```{r get_results}
# Z-score = 2 ####
z_score_2_results <- readRDS(file = "use_case_data/gdc_data/kpm_results/ines_greedy_results_prostate_tumor_z_score_2.rds")
z_score_2_indicator_matrix <- readRDS(file = "use_case_data/gdc_data/data/counts_matrix_z_2.rds") 
# Z-score = 3 ####
...
z_score_2_results@configurations$`K-3-L1-250`
selected_pathway <- get_pathway(configuration = z_score_2_results@configurations$`K-3-L1-250`, pathway_name = "Pathway-1")
saveRDS(selected_pathway, file = "use_case_data/gdc_data/pathway_comparison/selected_pathway_z2.rds")
```